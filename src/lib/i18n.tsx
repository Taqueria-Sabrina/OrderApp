...
const ES: Dict = {
  ...
  "menu.name_color": "Color del nombre",
  "menu.stock": "Stock",
  "menu.stock_na": "N/D",
  "menu.tortillas": "Tortillas",
  "menu.tortillas_sub": "Límite total de tacos (no afecta a los extras). En blanco = sin control.",
  "menu.tortillas_low": ({ n }) => `¡Solo quedan ${n} tortillas!`,
  "menu.tortillas_out": "¡No quedan tortillas! No se pueden vender tacos.",
  "menu.note_ph": "Descripción principal",
  "menu.note2_ph": "Se sirve con… (línea secundaria)",
  "menu.taco": "Taco",
  ...
  "dash.tacos_sold": ({ n }) => `${n} artículo${Number(n) === 1 ? "" : "s"}`,
  ...
  "recovery.kicker": "Trastienda · Seguridad",
  "recovery.title": "Recuperación",
  "recovery.sub": "Todo lo borrado se guarda aquí y se puede restaurar.",
  "recovery.loading": "Cargando…",
  "recovery.empty": "Nada borrado. Todo está en su sitio.",
  "recovery.orders": "Pedidos borrados",
  "recovery.items": "Artículos borrados",
  "recovery.archives": "Servicios borrados",
  "recovery.restore": "Restaurar",
  "recovery.restoring": "Restaurando…",
  "recovery.purge": "Eliminar def.",
  "recovery.purge_confirm": "Introduce el código para eliminar esto para siempre. No se podrá recuperar.",
  "recovery.deleted_on": ({ d }) => `Borrado: ${d}`,
...
const EN: Dict = {
  ...
  "menu.name_color": "Name color",
  "menu.stock": "Stock",
  "menu.stock_na": "N/A",
  "menu.tortillas": "Tortillas",
  "menu.tortillas_sub": "Caps total tacos available (doesn't affect extras). Blank = untracked.",
  "menu.tortillas_low": ({ n }) => `Only ${n} tortillas left!`,
  "menu.tortillas_out": "Out of tortillas! No tacos can be sold.",
  "menu.note_ph": "Main description",
  "menu.note2_ph": "Served with… (secondary line)",
  "menu.taco": "Taco",
  ...
  "dash.tacos_sold": ({ n }) => `${n} item${Number(n) === 1 ? "" : "s"}`,
  ...
  "recovery.kicker": "Back of House · Safety",
  "recovery.title": "Recovery",
  "recovery.sub": "Everything deleted is kept here and can be restored.",
  "recovery.loading": "Loading…",
  "recovery.empty": "Nothing deleted. Everything's in place.",
  "recovery.orders": "Deleted orders",
  "recovery.items": "Deleted items",
  "recovery.archives": "Deleted services",
  "recovery.restore": "Restore",
  "recovery.restoring": "Restoring…",
  "recovery.purge": "Delete forever",
  "recovery.purge_confirm": "Enter the passcode to delete this permanently. It can't be recovered.",
  "recovery.deleted_on": ({ d }) => `Deleted: ${d}`,
